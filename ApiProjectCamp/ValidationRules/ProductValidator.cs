...
namespace ApiProjectCamp.ValidationRules
{
    public class ProductValidator : AbstractValidator<Product>
    {
        public ProductValidator()
        {
            ...
            RuleFor(x => x.Price).NotEmpty().WithMessage("Ürün fiyatı boş geçilemez.").LessThan(0).WithMessage("Fiyatı 0'dan büyük giriniz.").GreaterThan(1000).WithMessage("Ürün fiyatı bu kadar yüksek olamaz, girdiğiniz değeri kontrol ediniz!");
